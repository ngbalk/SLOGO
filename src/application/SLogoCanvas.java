...
/**
 * Contains status of background color and reference-grid. Serves as the canvas
 * to hold and display the Lines generated by turtles.
 * 
...
public class SLogoCanvas {
	...
	/**
	 * Add a new color to the parsing-defined color palette
	 * @param index
	 * @param color
	 */
